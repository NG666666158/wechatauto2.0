...
install_requires=[
'emoji>=2.14.1','PyAutoGUI>=0.9.54','pycaw>=20240210','pywin32>=308','pywin32-ctypes>=0.2.2','pywinauto>=0.6.8','psutil>=5.9.5','pillow>=10.4.0','python-multipart>=0.0.20','python-docx>=1.1.2','pypdf>=4.3.1']
)
'''
Author:Hello-Mr-Crab
