...
def build_api_fixtures() -> dict[str, dict[str, object]]:
    ...
    fixtures = {
        ...
        "knowledge/knowledge.trusted-rebuild.json": success_response(
            KnowledgeTrustedRebuildResultData(
                accepted=True,
                status="rebuilt",
                reason_code="",
                ...
                trusted_rebuild_provider="TrustedLocalEmbeddings",
                trusted_rebuild_block_reason="",
                index_status=KnowledgeStatusData(
                    ready=True,
                    index_path="data/knowledge/local_knowledge_index.json",
                    documents_loaded=18,
                    chunks_created=426,
                    last_built_at="2026-04-25T09:45:00+08:00",
                    embedding_provider="TrustedLocalEmbeddings",
                    embedding_trusted=True,
                    supported_extensions=[".pdf", ".docx", ".txt", ".md", ".png", ".jpg"],
                ),
                trust_diagnostics=KnowledgeTrustDiagnosticsData(
                    ready=True,
                    embedding_provider="TrustedLocalEmbeddings",
                    embedding_trusted=True,
            ...
            trace_id="fixture-knowledge-trusted-rebuild",
        ),
